...
<style lang="postcss">
	...
	.list {
		@apply flex shrink-0 border-b border-gray-100 bg-white data-[orientation=vertical]:flex-col
	...
	.trigger {
      ...
      justify-center rounded-none bg-white px-5 leading-none text-gray-900
			 focus:relative;
	}

	.trigger[data-orientation='vertical'] {
		@apply w-full flex-grow-0 rounded-none border-b border-r-2 border-transparent border-b-gray-100 py-4  last:border-b-0;
	}

	.trigger[data-state='active'] {
		@apply text-gray-700 focus:relative;
	}
	...
	/* Content Elements */
	.description {
		@apply mb-5 leading-normal text-gray-950;
	}
	...
	label {
		@apply mb-2.5 block text-sm leading-none text-gray-950;
	}

	input {
		@apply h-8 shrink-0 grow rounded border px-2.5 leading-none text-gray-900  focus:ring focus:ring-gray-800;
	}
